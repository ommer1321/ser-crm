                    ...
                    <form action="{{ route('store.task') }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-4 mt-3 mt-xl-0">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" name="finished_at" type="date" value="{{ old('finished_at') }}"
                            ...
                            <div class="">
                                <div class="dropdown float-end">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item" href="#">Göster</a>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <a href="javascript: void(0);" class="d-block" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="{{ $task->title }}">
                                        <div class="avatar">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden mx-2">
                                        ...
                                        <span class="badge badge-soft-{{$task->status_color}} mb-0">{{$task->status_tr}}</span>
                                ...
                                <div class="mt-3 pt-1">
                                    ...
                                    <div class="progress animated-progess custom-progress">
                                        <div class="progress-bar bg-gradient bg-{{$task->status_color}}" role="progressbar"
                                            style="width: {{$task->percent_time}}%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="90">
                                        </div>
                                    </div>
                                </div>
