        ...
        d = (function () {
            function z(e, t) {
                ...
                if (
                    ...
                    n.options.forceFallback || !z.isBrowserSupported())
                )
                ...
                return (
                    ...
                    !1 !== n.options.previewsContainer &&
                        (n.options.previewsContainer
                            ? (n.previewsContainer = z.getElement(
                                  n.options.previewsContainer,
                                  "previewsContainer"
                              ))
                    ...
                    n.options.clickable &&
                        (!0 === n.options.clickable
                            ...
                            : (n.clickableElements = z.getElements(
                                  n.options.clickable,
                                  "clickable"
                              ))),
                    n.init(),
                                ...
                                (this.prototype.defaultOptions = {
                                    ...
                                    addedfile: function (t) {
                                        ...
                                        if (
                                            ...
                                            (t.previewElement = z.createElement(
                                ...
                                if (
                                    ...
                                    !(function l() {
                                        return (
                                            ...
                                            (s.hiddenFileInput.style.left =
                                                "0"),
                                            (s.hiddenFileInput.style.height =
                                                "0"),
                                            (s.hiddenFileInput.style.width =
                                                "0"),
                                            z
                                                .getElement(
                                                    s.options
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                for (var h in (this.options.headers &&
                                    z.extend(d, this.options.headers),
                                d)) {
                                    var p = d[h];
        ...
        (d.isBrowserSupported = function () {
            ...
            if (
                ...
                if ("classList" in document.createElement("a")) {
                    ...
                    try {
                        for (
                            var r, o = d.blacklistedBrowsers[Symbol.iterator]();
                            !(t = (r = o.next()).done);
                            t = !0
                        ) {
        ...
        (d.getElements = function (e, t) {
            ...
            if (e instanceof Array) {
                ...
                try {
                    for (
                        var h,
                            p = document.querySelectorAll(e)[Symbol.iterator]();
                        !(u = (h = p.next()).done);
                        u = !0
                    )
                        (n = h.value), i.push(n);
