...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // $.get("http://localhost:8000/calendar/api", function(response) {
    //     return response.data
    //   });

    // ----------------
      //   console.log(ommer1453);
    // ----------------
...
var c = apiData ,
    ...
    var g = new FullCalendar.Calendar(m, {
        ...
        // events: $.get("http://localhost:8000/calendar/api", function(response) {
        //          return response.data
        //        }),
